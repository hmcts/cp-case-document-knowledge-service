...
public class RetrieveMaterialAndUploadTask implements ExecutableTask {
    ...
    public ExecutionInfo execute(final ExecutionInfo executionInfo) {
        ...
        try {
            ...
            final List<MetadataFilter> documentMetadata = createUploadMetadata(caseId, defendantId, materialId, materialName, today);
            ...
            //pass documentReference from fileStorageLocation
    ...
    private List<MetadataFilter> createUploadMetadata(final UUID caseId, final UUID defendantId, final UUID materialId,
                                                      final String materialName, final String uploadedDate) {
        try {
            return List.of(
                    ...
                    new MetadataFilter(META_MATERIAL_NAME, materialName),

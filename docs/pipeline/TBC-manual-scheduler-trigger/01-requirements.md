...
> **Jira: TBC** — rename this folder to `<JIRA-TICKET>-manual-scheduler-trigger` once raised.
> Gate decisions (concurrency, response contract, granularity, path) are folded in below — see `02-design.md` and `adrs.md` (ADR-001/002).
